...
gmt grdimage topo15.grd -Cseafloor -R140/162/-15/0 -JM16c -P -I+a15+ne0.75 -Xc -K > $ps
...
gmt psscale -Dg136.5/-15+w11.0c/0.4c+v+o0.3/0i+ml -Rnbt_relief.nc -J -Cseafloor \
...
2.0 10.0 Base map: SRTM Global Relief Model 15 arc sec grid. Color palette: 'seafloor'.
EOF
# Add GMT logo
