...
gmt grdcut earth_relief_01m.grd -R120/134/20/33 -Grt_relief.nc -V
...
gmt makecpt -Cglobe.cpt -V -T-8000/1000 > myocean.cpt
# Step-5. Make raster image
gmt grdimage rt_relief.nc -Cmyocean.cpt -R120/134/20/33 -JL127/27/24/30/6i \
...
gmt psxy -R -J ridge.gmt -Sf0.5c/0.15c+l+t -Wthin,red -Gred -O -K >> $ps
...
# Step-11.
gmt psxy -R -J GSFML_SF_FZ_KM.gmt -Wthick,chartreuse1 -O -K >> $ps
...
gmt psxy -R -J -Sv0.5c+ea -Glightyellow1 -W1.2p,lightyellow1 -O -K << EOF >> $ps
124.8 22.0 140 1.2c
128.5 23.5 140 1.2c
130.2 24.6 140 1.2c
132.4 28.6 140 1.2c
...
S 0.3c t 0.4c green 0.02c 1.0c Sedimentary rate 1000 m/Ma
S 0.3c t 0.3c green 0.02c 1.0c Sedimentary rate 500 m/Ma
S 0.3c a 0.4c magenta 0.02c 1.0c Hydrothermal area
S 0.3c v 1.2c lightyellow1 0.01c 1.0c Convergence rate mm/yr
S 0.3c - 0.8c - 0.5p,chartreuse1 1.0c Magnetic anomalies
S 0.3c - 0.8c - 0.5p,brown 1.0c Tectonic slabs
S 0.3c - 1.2c - 0.5p,orange 1.0c Tectonic faults
S 0.3c f+l+t 0.7c red 0.01c 1.0c Ridge
S 0.3c f+l+t 0.7c yellow 0.01c 1.0c Trench
FIN
# Step-12. Add subtitle
gmt pstext -R0/10/0/15 -JX10/10 -X0.0c -Y6.0c -N -O -K \
    -F+f12p,Palatino-Roman,black+jLB >> $ps << EOF
2.5 15.0 ETOPO 1 global terrain model, 1 min resolution grid
EOF
