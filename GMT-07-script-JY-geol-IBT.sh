...
gmt grdimage ibts_relief.nc -Cbathy.cpt -R128/150/20/36 -JM16c -P -I+a15+ne0.75 -Xc -K > $ps
# Add elemens of basemap: title, grids, rose, scale, time stamp
gmt psbasemap -R -J \
    -B+t"Geological and tectonic settings of the Izu-Bonin Trench" \
...
gmt grdcontour ibts_relief.nc -R -J -C500 -W0.1p -O -K >> $ps
# Step-7. Add color legend
gmt psscale -Dg124.5/20+w13.0c/0.4c+v+o0.3/0i+ml -Ribts_relief.nc -J -Cbathy.cpt \
    --FONT_LABEL=8p,Helvetica,dimgray \
